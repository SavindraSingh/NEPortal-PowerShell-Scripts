<#
    .SYNOPSIS
    Script to Get List of Image Offer Names

    .DESCRIPTION
    Script to Get list of Image Offer Names available in Azure Resource Manager Portal
    ...
    .NOTES
     Purpose of script: Get list of available Image Offer Names
    ...
    .EXAMPLE
    C:\PS> .\Get-ListOfImageOffers.ps1  -AzureUserName "testlab@netenrich.com" -AzurePassword 'pass12@w0rd' -AzureSubscriptionID 'ae7c7576-f01c-4026-9b94-d05e04e459fc' -Location 'East US' -PublisherName 'virtualworks'
...
Process
{
    ...
    # 2. Fetch List of Image Offer Names
    Try
    {
        ($arrImageOffers = (Get-AzureRmVMImageOffer -Location $Location -PublisherName $PublisherName -ErrorAction Stop -WarningAction SilentlyContinue).Offer) | Out-Null
        $ImageOffers = (@{ "Response" = [Array]$arrImageOffers; "Status" = "Success"} | ConvertTo-Json)
        Write-Output $ImageOffers
    }
    Catch
    {
